...
| 051-final-docs-consistency-check | Reconcile final capture, Ask, H2H, and demo documentation | Documentation-only; no product, benchmark, evaluator, or provider changes | current task | [prompt](trajectories/coding/051-final-docs-consistency-check/prompt.md), [summary](trajectories/coding/051-final-docs-consistency-check/summary.md) |
| 052-final-h2h-002-and-clean-submission | Run the sealed native-chat comparison and prepare the clean archive | H2H-002 recorded; submission-only material moved outside the repository; no product change | current task | [prompt](trajectories/coding/052-final-h2h-002-and-clean-submission/prompt.md), [summary](trajectories/coding/052-final-h2h-002-and-clean-submission/summary.md), [report](docs/FINAL_NATIVE_CHAT_H2H.md) |
...
The current filesystem inventory contains 53 coding trajectories and 55 runtime

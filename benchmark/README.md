...
This directory defines the intended boundary between development cases and evaluator-controlled holdout material. The Gate A benchmark contract proposal is documented in [docs/EVALUATION.md](../docs/EVALUATION.md#18-gate-a-review-status) and is pending human review. The final event count is not frozen: the separate non-scored [size calibration](calibration/README.md) compares 50, 100, 200, and 400-event histories with high state churn. The intended primary remains approximately 150–200 events if calibration supports it; 400 is a secondary stress candidate. This directory contains no final benchmark cases or final expected outputs.

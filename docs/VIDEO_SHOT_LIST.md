...
| 3:15–3:45 | Results | Show `eval/results/experiment-003-retrieval-full-v3.json` | Advanced replay and checkpoints |
| 3:45–4:00 | Caveat | Show Experiment 003 relation-reconciliation result and remaining unresolved detail in changelog/decision log | Honest measured limitation |

...
| 0:45–1:05 | Out of mind state | Click Save capture; briefly show `Out of mind` and the recent raw capture | Immutable raw capture, asynchronous understanding |
...
| 2:00–2:30 | Ask | Run “What changed recently?” then “What information is incomplete?” | Bounded evidence and provider-rendered READY answer; deterministic responsibilities remain local |
...
- Show the `Out of mind` feedback, not an invented semantic classification
  response.
